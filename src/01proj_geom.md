...
- "Line": $[a, b, c]$ represents the _great circle_ intersecting the
...
- The points on a line $AB$ can be parameterized by
...
- The locus of self-conjugate points defines a _conic_. However,
...
- Any other line is called a _secant_ or a _nonsecant_ according to
