...
- In hyperbolic geometry, the projection of the fundamental cone onto
  the 2D plane is a unit circle, the so-called _null circle_. The
...
- We call the line $m$ the _mirror_ and the point $o$ the _center_ of
  the involution.
...
- Furthermore, the points meet($m^2_{ab}, c$_), meet($m^2_{bc}, a$_),
...
- Then one set of midpoints $m^1_{pq}$_, $m^1_{qr}$_, $m^1_{pr}$\_ are
  collinear.

- Furthermore, the lines join($m^2_{pq}, r$_), join($m^2_{qr}, p$_),
